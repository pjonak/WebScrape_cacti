...
def buildSQL_insertDataFrame__getColType(hConn: mysqlConnection,
    ...
    for colName in colList:
        ...
        # dataType = res[res['column_name'] == colName]['data_type'].values[0]
        #
        # if dataType[len(dataType)-3::].lower() == "int" or dataType[0:3].lower() == "int":
        #     typeList[iCol] = 1
        # else:
        #     typeList[iCol] = 0
        #
    ...
    # print(res)
    # print(res.irow(4))
    # print(res.irow(4)["column_name"])
    # print(res.irow(4)["data_type"])
    #
    # print(res[res['column_name'] == colList[4]])
    # print(type(res[res['column_name'] == colList[4]]))
    # print(res[res['column_name'] == colList[4]]['data_type'])
    # print(type(res[res['column_name'] == colList[4]]['data_type']))
    # print(res[res['column_name'] == colList[4]]['data_type'].values[0])
    # print(type(res[res['column_name'] == colList[4]]['data_type'].values[0]))

    # print(res[res['column_name'] == 'fakeCol']['data_type'])
    # print(res[res['column_name'] == 'fakeCol']['data_type'].empty)
    # print(res[res['column_name'] == 'fakeCol']['data_type'].values[0])
    # print(res[res['column_name'] == 'fakeCol']['data_type'].values[0].empty)
...
#                 # Get new URL
#                 if nRow == 0:
#                     print("No jobs pending nor active!")
#                 else:
#                     tempStr = hBrowser.current_url.split("rows_selector=")
#                     hBrowser.get(
#                         tempStr[0] + "rows_selector=" + str(nRow) + "&" + tempStr[1].split("&", 1)[1]
#                     )
#
#
...
#
#                     #  Get new handle to parent of element which pointed to class "noprint"
#                     table_data = None
#                     table_refresh = None
#
#                     elemList = hBrowser.find_elements_by_xpath('//table[@class="cactiTable"]')
